...
import menu from '../../assets/icon3.png'
...
const Navbar = () => {
  ...
  return (
    <nav className={`container ${sticky? 'dark_nav':""}`}>
      <img src={logo} alt="" className='myMenu'/>
      <ul className={mobileMenu? '':'hide-mobile-menu'}> 
        ...
        <li><Link to='programs' smooth={true} offset={-200} duration={500}>Programs</Link></li>
         ...
         <li><Link to="contact" smooth={true} offset={-260} duration={500}className='btn dark-btn'>Contact</Link></li>
      </ul>
